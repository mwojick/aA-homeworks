...
exports.fetchGiphys = exports.receiveSearchGiphys = exports.REQUEST_SEARCH_GIPHYS = exports.RECEIVE_SEARCH_GIPHYS = undefined;
...
var fetchGiphys = exports.fetchGiphys = function fetchGiphys(searchTerm) {
...
var GiphysSearch = function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var searchTerm = this.state.search.split(' ').join('+');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { value: search, onChange: this.handleChange, placeholder: 'Search for a gif!' }),
          _react2.default.createElement('input', { type: 'submit', value: 'Search Giphy' })
        ),
...
var _giphy_actions = __webpack_require__(60);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchGiphys: function fetchGiphys(searchTerm) {
      return dispatch((0, _giphy_actions.fetchGiphys)(searchTerm));
    }
  };
};
...
// import {receiveSearchGiphys, fetchGiphys} from './actions/giphy_actions';
//
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(58), __webpack_require__(217)(module)))
